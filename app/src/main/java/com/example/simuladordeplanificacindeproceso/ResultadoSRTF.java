...
public class ResultadoSRTF extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resultado_srtf);
        ...
        ResultadoSRTF.procesosEstructura[] proceso = new ResultadoSRTF.procesosEstructura[100];
        ResultadoSRTF.procesosEstructura tmp = new ResultadoSRTF.procesosEstructura(); //para ordenar los vectores en el metodo burbuja

        //====inicializar todos los vectores posicioin sino da error====
        for (int i = 0; i < 100; i++) {
            proceso[i] = new ResultadoSRTF.procesosEstructura();
        }
        //===========================================================
        ...
        //============================================================
        //metodo de ordenar el vector por ser un SRTF POR duracion
