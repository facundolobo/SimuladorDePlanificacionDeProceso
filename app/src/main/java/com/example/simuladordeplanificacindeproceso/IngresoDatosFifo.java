...
public class IngresoDatosFifo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ingreso_datos_fifo);

        //String cantidad = getIntent().getStringExtra("dato");// no hace nada
    ...
    public void RegistrarProceso(View view){
        ...
        AdminSQLiteOpenHelper admin=new AdminSQLiteOpenHelper(this,"planificacion", null,1);
        SQLiteDatabase BaseDeDatos= admin.getWritableDatabase(); //lectura
        //============================
    ...
    public void calcular(View view){
        ...
        Intent i=new Intent(this, ResultadoFifo.class);
        startActivity(i);
    }
