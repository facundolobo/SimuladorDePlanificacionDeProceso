...
public class ResultadoPrioridadDecrecienteApropiativo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resultado_prioridad_decreciente_apropiativo);
        ...
        ResultadoPrioridadDecrecienteApropiativo.procesosEstructura[] proceso = new ResultadoPrioridadDecrecienteApropiativo.procesosEstructura[100];
        ResultadoPrioridadDecrecienteApropiativo.procesosEstructura tmp = new ResultadoPrioridadDecrecienteApropiativo.procesosEstructura(); //para ordenar los vectores en el metodo burbuja

        //====inicializar todos los vectores posicioin sino da error====
        for (int i = 0; i < 100; i++) {
            proceso[i] = new ResultadoPrioridadDecrecienteApropiativo.procesosEstructura();
        }
        //===========================================================
