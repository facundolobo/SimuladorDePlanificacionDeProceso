...
public class IngresoDatosPrioridadDecrecienteApropiativo extends AppCompatActivity {
    ...
    public void calcular(View view) {
        ...
        Intent i = new Intent(this, ResultadoPrioridadDecrecienteApropiativo.class);
        startActivity(i);
    }
