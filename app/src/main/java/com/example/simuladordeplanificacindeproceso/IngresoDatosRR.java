...
public class IngresoDatosRR extends AppCompatActivity {

    private EditText ET_nombre_proceso, ET_llegada, ET_duracion,ET_quantum;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ingreso_datos_rr);
        ...
        ET_quantum = (EditText) findViewById(R.id.Quantum);
    ...
    public void calcular(View view) {
        ...
        String Quantum = ET_quantum.getText().toString();
        System.out.println("valor 1 Q=" + Quantum);
        if (Quantum.isEmpty()){
            Toast.makeText(this, "necesita Quantum para calcular", Toast.LENGTH_SHORT).show();
        }else {

            Intent i = new Intent(this, ResultadoRR.class);

            System.out.println("valor 2 Q=" + Quantum);
            i.putExtra("Quantum1", Quantum);
