...
public class IngresoDatosPrioridadCrecienteNoApropiativo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ingreso_datos_prioridad_creciente_no_apropiativo);
    ...
    public void calcular(View view) {
        ...
        Intent i = new Intent(this, ResultadoPrioridadCrecienteNoApropiativo.class);
        startActivity(i);
    }
    ...
    public void agregarPrioridadProceso(View view) {
        ...
        if (!nombre_proceso.isEmpty()) {
            ...
            if (!prioridad_nueva.isEmpty()) {
                ...
                if (cantidad==1){
                    Toast.makeText(this, "prioridad agregada/modificada", Toast.LENGTH_SHORT).show();ET_nombre_proceso.setText("");
                    ET_duracion.setText("");
                    ET_llegada.setText("");
                    ET_prioridad.setText("");
