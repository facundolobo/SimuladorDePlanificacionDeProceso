...
public class IngresoDatosSRTF extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ingreso_datos_srtf);
    ...
    public void calcular(View view) {
        ...
        Intent i = new Intent(this, ResultadoSRTF.class);
        startActivity(i);
    }
}
