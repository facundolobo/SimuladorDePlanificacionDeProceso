...
public class ResultadoPrioridadDecrecienteNoApropiativo extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_resultado_prioridad_decreciente_no_apropiativo);
        ...
        ResultadoPrioridadDecrecienteNoApropiativo.procesosEstructura[] proceso = new ResultadoPrioridadDecrecienteNoApropiativo.procesosEstructura[100];
        ResultadoPrioridadDecrecienteNoApropiativo.procesosEstructura tmp = new ResultadoPrioridadDecrecienteNoApropiativo.procesosEstructura(); //para ordenar los vectores en el metodo burbuja

        //====inicializar todos los vectores posicioin sino da error====
        for (int i = 0; i < 100; i++) {
            proceso[i] = new ResultadoPrioridadDecrecienteNoApropiativo.procesosEstructura();
        }
        //===========================================================
